...
import cn.foggyhillside.endsdelight.world.gen.ConfiguredFeatures;
...
public class ModFeatures {
    ...
    public static final RegistryObject<ChorusSucculentFeature> CHORUS_SUCCULENT_FEATURE = FEATURES
            .register("chorus_succulent_feature", () -> new ChorusSucculentFeature(FeatureSpreadConfig.CODEC));

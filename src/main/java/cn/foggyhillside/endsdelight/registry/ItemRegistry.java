...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> ChorusFruitCrate = ITEMS.register("chorus_fruit_crate",
            ()-> new BlockItem(BlockRegistry.ChorusFruitCrate.get(), new Item.Properties().group(EndsDelightGroup.ends_delightGroup)));
    public static final RegistryObject<Item> EndStove = ITEMS.register("end_stove",
            ()-> new BlockItem(BlockRegistry.EndStove.get(), new Item.Properties().group(EndsDelightGroup.ends_delightGroup)));
    //knife
    ...
    public static final RegistryObject<Item> DragonToothKnife = ITEMS.register("dragon_tooth_knife",
            ()->new KnifeItem(MaterialRegistry.DRAGON_TOOTH, 0.5F, -2.0F, new Item.Properties().group(EndsDelightGroup.ends_delightGroup)));
    ...
    public static final RegistryObject<Item> LiquidDragonEgg = ITEMS.register("liquid_dragon_egg",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.LiquidDragonEgg).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> FriedDragonEgg = ITEMS.register("fried_dragon_egg",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.FriedDragonEgg).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> ShulkerMeat = ITEMS.register("shulker_meat",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.ShulkerMeat).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> ShulkerMeatSlice = ITEMS.register("shulker_meat_slice",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.ShulkerMeatSlice).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> RoastedShulkerMeat = ITEMS.register("roasted_shulker_meat",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.RoastedShulkerMeat).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> RoastedShulkerMeatSlice = ITEMS.register("roasted_shulker_meat_slice",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.RoastedShulkerMeatSlice).group(EndsDelightGroup.ends_delightGroup), true));
    ...
    public static final RegistryObject<Item> SmokedDragonLeg = ITEMS.register("smoked_dragon_leg",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.SmokedDragonLeg).group(EndsDelightGroup.ends_delightGroup), true));
    ...
    public static final RegistryObject<Item> RoastedDragonMeat = ITEMS.register("roasted_dragon_meat",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.RoastedDragonMeat).group(EndsDelightGroup.ends_delightGroup), true));
    ...
    public static final RegistryObject<Item> RoastedDragonMeatCuts = ITEMS.register("roasted_dragon_meat_cuts",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.RoastedDragonMeatCuts).group(EndsDelightGroup.ends_delightGroup), true));
    ...
    public static final RegistryObject<Item> DriedEnderMiteMeat = ITEMS.register("dried_endermite_meat",
            ()-> new Item(new Item.Properties().food(FoodList.DriedEnderMiteMeat).group(EndsDelightGroup.ends_delightGroup)));
    public static final RegistryObject<Item> EnderSauce = ITEMS.register("ender_sauce",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.EnderSauce).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup)));
    public static final RegistryObject<Item> StuffedRiceCake = ITEMS.register("stuffed_rice_cake",
            ()-> new ChorusFruitPieSliceItem(new Item.Properties().food(FoodList.StuffedRiceCake).group(EndsDelightGroup.ends_delightGroup)));
    public static final RegistryObject<Item> ChorusFlowerPie = ITEMS.register("chorus_flower_pie",
            ()-> new ChorusFruitPieSliceItem(new Item.Properties().food(FoodList.ChorusFlowerPie).group(EndsDelightGroup.ends_delightGroup),true));
    //Drink
    ...
    public static final RegistryObject<Item> DragonBreathSoda = ITEMS.register("dragon_breath_soda",
            ()-> new DragonBreathSodaItem(new Item.Properties().food(FoodList.DragonBreathSoda).maxStackSize(16).containerItem(Items.GLASS_BOTTLE).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> ChorusFlowerTea = ITEMS.register("chorus_flower_tea",
            ()-> new ChorusFlowerTeaItem(new Item.Properties().food(FoodList.ChorusFlowerTea).maxStackSize(16).containerItem(Items.GLASS_BOTTLE).group(EndsDelightGroup.ends_delightGroup), true, true));
    //Cookie
    public static final RegistryObject<Item> ChorusCookie = ITEMS.register("chorus_cookie",
            ()-> new ChorusFruitPieSliceItem(new Item.Properties().food(FoodList.ChorusCookie).group(EndsDelightGroup.ends_delightGroup)));
    //Popsicle
    ...
    public static final RegistryObject<Item> ChorusFruitPieSlice = ITEMS.register("chorus_fruit_pie_slice",
            ()-> new ChorusFruitPieSliceItem(new Item.Properties().food(Foods.PIE_SLICE).group(EndsDelightGroup.ends_delightGroup), true));
    //Congee
    public static final RegistryObject<Item> EnderCongee = ITEMS.register("ender_congee",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.EnderCongee).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true));
    //Soup
    public static final RegistryObject<Item> DragonBreathAndChorusSoup = ITEMS.register("dragon_breath_and_chorus_soup",
            ()-> new DragonBreathAndChorusSoupItem(new Item.Properties().food(FoodList.DragonBreathAndChorusSoup).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true, true));
    //ConsumableItem
    public static final RegistryObject<Item> StirFriedShulkerMeat = ITEMS.register("stir_fried_shulker_meat",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.StirFriedShulkerMeat).maxStackSize(16).containerItem(Items.BOWL).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> RoastedDragonSteak = ITEMS.register("roasted_dragon_steak",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.RoastedDragonSteak).maxStackSize(16).containerItem(Items.BOWL).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> EndMixedSalad = ITEMS.register("end_mixed_salad",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.EndMixedSalad).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true));
    public static final RegistryObject<Item> AssortedSalad = ITEMS.register("assorted_salad",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.AssortedSalad).containerItem(ItemRegistry.DragonEggShell.get()).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true));
    //BarbecueStick
    public static final RegistryObject<Item> EndBarbecueStick = ITEMS.register("end_barbecue_stick",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.EndBarbecueStick).group(EndsDelightGroup.ends_delightGroup), true));
    //Feast
    ...
    public static final RegistryObject<Item> DragonMeatStew = ITEMS.register("dragon_meat_stew",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.DragonMeatStew).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true));
    ...
    public static final RegistryObject<Item> GrilledShulker = ITEMS.register("grilled_shulker",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.GrilledShulker).containerItem(Items.BOWL).maxStackSize(16).group(EndsDelightGroup.ends_delightGroup), true));
}

...
public class FoodList {
    ...
    public static final FoodProperties SmokedDragonLeg = new FoodProperties.Builder().nutrition(14).saturationMod(0.5F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,10*20,1),1).build();
    ...
    public static final FoodProperties DragonMeatStew = new FoodProperties.Builder().nutrition(10).saturationMod(0.6F).effect(() -> new MobEffectInstance(MobEffects.ABSORPTION,75*20,2),1).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,15*20,1),1).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST,30*20,1),1).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(),300*20,0),1).build();
    ...
    public static final FoodProperties SteamedDragonEgg = new FoodProperties.Builder().nutrition(12).saturationMod(0.6F).effect(() -> new MobEffectInstance(MobEffects.ABSORPTION,75*20,2),1).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(),300*20,0),1).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,75*20,1),1).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST,75*20,1),1).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE,75*20,1),1).build();
    ...
    public static final FoodProperties RoastedDragonSteak = new FoodProperties.Builder().nutrition(18).saturationMod(0.5F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,25*20,1),1).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(),300*20,0),1).alwaysEat().build();
    public static final FoodProperties EnderSauce = new FoodProperties.Builder().nutrition(3).saturationMod(0.5F).build();
    public static final FoodProperties ChorusCookie = new FoodProperties.Builder().nutrition(2).saturationMod(0.6F).build();
    public static final FoodProperties SuspiciousDragonCore = new FoodProperties.Builder().nutrition(5).saturationMod(0.7F).effect(() -> new MobEffectInstance(MobEffects.BLINDNESS,60*20,0),1).effect(() -> new MobEffectInstance(MobEffects.POISON,60*20,0),0.5F).effect(() -> new MobEffectInstance(MobEffects.WEAKNESS,60*20,0),0.5F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE,60*20,1),0.2F).build();
    public static final FoodProperties EnderCongee = new FoodProperties.Builder().nutrition(10).saturationMod(0.6F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,15*20,1),1).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE,45*20,1),1).effect(() -> new MobEffectInstance(MobEffects.HEALTH_BOOST,45*20,2),1).alwaysEat().build();
    public static final FoodProperties DragonLegWithSauce = new FoodProperties.Builder().nutrition(10).saturationMod(0.7F).effect(() -> new MobEffectInstance(MobEffects.ABSORPTION,75*20,2),1).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,15*20,1),1).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(),300*20,0),1).build();
}

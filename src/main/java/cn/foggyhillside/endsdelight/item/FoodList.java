...
public class FoodList {
    ...
    public static final Food ShulkerMeatSlice = new Food.Builder().hunger(2).saturation(0.6F).effect(() -> new EffectInstance(Effects.LEVITATION,2*20,1),1).fastToEat().setAlwaysEdible().build();
    ...
    public static final Food SmokedDragonLeg = new Food.Builder().hunger(14).saturation(0.5F).effect(() -> new EffectInstance(Effects.REGENERATION,10*20,1),1).build();
    ...
    public static final Food StuffedRiceCake = new Food.Builder().hunger(6).saturation(0.7F).setAlwaysEdible().build();
    public static final Food RawEnderMiteMeat = new Food.Builder().hunger(3).saturation(0.6F).build();
    public static final Food DriedEnderMiteMeat = new Food.Builder().hunger(5).saturation(0.6F).build();
    ...
    public static final Food ChorusFlowerTea = new Food.Builder().hunger(0).saturation(0.0F).effect(() -> new EffectInstance(Effects.REGENERATION, 5*20, 1),1).effect(() -> new EffectInstance(Effects.RESISTANCE, 20*20, 0),1).setAlwaysEdible().build();
    ...
    public static final Food RoastedShulkerMeatSlice = new Food.Builder().hunger(3).saturation(0.8F).effect(() -> new EffectInstance(Effects.LEVITATION,2*20,1),1).fastToEat().setAlwaysEdible().build();
    public static final Food RawDragonMeatCuts = new Food.Builder().hunger(3).saturation(0.6F).fastToEat().build();
    public static final Food RoastedDragonMeatCuts = new Food.Builder().hunger(6).saturation(0.6F).effect(() -> new EffectInstance(Effects.REGENERATION,5*20,1),1).fastToEat().setAlwaysEdible().build();
    public static final Food DragonMeatStew = new Food.Builder().hunger(10).saturation(0.6F).effect(() -> new EffectInstance(Effects.ABSORPTION,75*20,2),1).effect(() -> new EffectInstance(Effects.REGENERATION,15*20,1),1).effect(() -> new EffectInstance(Effects.STRENGTH,30*20,1),1).effect(() -> new EffectInstance(ModEffects.NOURISHED.get(),300*20,0),1).build();
    ...
    public static final Food SteamedDragonEgg = new Food.Builder().hunger(12).saturation(0.6F).effect(() -> new EffectInstance(Effects.ABSORPTION,75*20,2),1).effect(() -> new EffectInstance(ModEffects.NOURISHED.get(),300*20,0),1).effect(() -> new EffectInstance(Effects.REGENERATION,75*20,1),1).effect(() -> new EffectInstance(Effects.STRENGTH,75*20,1),1).effect(() -> new EffectInstance(Effects.RESISTANCE,75*20,1),1).build();
    ...
    public static final Food RoastedDragonSteak = new Food.Builder().hunger(18).saturation(0.5F).effect(() -> new EffectInstance(Effects.REGENERATION,25*20,1),1).effect(() -> new EffectInstance(ModEffects.NOURISHED.get(),300*20,0),1).setAlwaysEdible().build();
    public static final Food EnderSauce = new Food.Builder().hunger(3).saturation(0.5F).build();
    public static final Food ChorusCookie = new Food.Builder().hunger(2).saturation(0.6F).build();
    public static final Food EnderCongee = new Food.Builder().hunger(10).saturation(0.6F).effect(() -> new EffectInstance(Effects.REGENERATION,15*20,1),1).effect(() -> new EffectInstance(Effects.RESISTANCE,45*20,1),1).effect(() -> new EffectInstance(Effects.HEALTH_BOOST,45*20,2),1).setAlwaysEdible().build();
}

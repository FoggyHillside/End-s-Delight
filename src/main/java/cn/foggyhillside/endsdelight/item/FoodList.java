...
public class FoodList {
    ...
    public static final FoodProperties EnderSause = new FoodProperties.Builder().nutrition(3).saturationMod(0.5F).build();
    ...
    public static final FoodProperties RoastedDragonLeg = new FoodProperties.Builder().nutrition(10).saturationMod(0.7F).effect(() -> new MobEffectInstance(MobEffects.ABSORPTION,75*20,2),1).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,15*20,1),1).build();
}

...
public class EndsDelight {
    ...
    public EndsDelight() {
        ...
        ModBlockEntityTypes.TILES.register(FMLJavaModLoadingContext.get().getModEventBus());
    ...
    private void clientSetup(final FMLClientSetupEvent event) {
            ItemBlockRenderTypes.setRenderLayer(BlockRegistry.ChorusSucculent.get(), RenderType.cutout());
    }
}

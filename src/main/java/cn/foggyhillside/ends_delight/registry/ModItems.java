...
public class ModItems {
    ...
    //BlockItem
    public static final Supplier<Item> CHORUS_FRUIT_CRATE = ITEMS.register("chorus_fruit_crate",
            () -> new BlockItem(ModBlocks.CHORUS_FRUIT_CRATE.get(), new Item.Properties()));
    public static final Supplier<Item> END_STOVE = ITEMS.register("end_stove",
            () -> new BlockItem(ModBlocks.END_STOVE.get(), new Item.Properties()));
    //knife
    public static final Supplier<Item> DRAGON_EGG_SHELL_KNIFE = ITEMS.register("dragon_egg_shell_knife",
    ...
    public static final Supplier<Item> PURPUR_KNIFE = ITEMS.register("purpur_knife",
            () -> new KnifeItem(ModMaterials.PURPUR, new Item.Properties().attributes(KnifeItem.createAttributes(
                    ModMaterials.PURPUR, 0.5F, -2.0F))));
    public static final Supplier<Item> END_STONE_KNIFE = ITEMS.register("end_stone_knife",
    ...
    public static final Supplier<Item> DRAGON_TOOTH_KNIFE = ITEMS.register("dragon_tooth_knife",
    ...
    public static final Supplier<Item> ENDER_PEARL_GRAIN = ITEMS.register("ender_pearl_grain",
            () -> new Item(new Item.Properties()));
    public static final Supplier<Item> CHORUS_FRUIT_GRAIN = ITEMS.register("chorus_fruit_grain",
            () -> new Item(new Item.Properties().food(FoodList.CHORUS_FRUIT_GRAIN)));
    public static final Supplier<Item> CHORUS_SUCCULENT = ITEMS.register("chorus_succulent",
            () -> new BlockItem(ModBlocks.CHORUS_SUCCULENT.get(), new Item.Properties().food(FoodList.CHORUS_SUCCULENT)));
    public static final Supplier<Item> DRIED_CHORUS_FLOWER = ITEMS.register("dried_chorus_flower",
            () -> new Item(new Item.Properties()));
    public static final Supplier<Item> DRAGON_TOOTH = ITEMS.register("dragon_tooth",
            () -> new Item(new Item.Properties()));
    public static final Supplier<Item> NON_HATCHABLE_DRAGON_EGG = ITEMS.register("non_hatchable_dragon_egg",
            () -> new Item(new Item.Properties().rarity(Rarity.RARE)));
    public static final Supplier<Item> HALF_DRAGON_EGG_SHELL = ITEMS.register("half_dragon_egg_shell",
            () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final Supplier<Item> LIQUID_DRAGON_EGG = ITEMS.register("liquid_dragon_egg",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.LIQUID_DRAGON_EGG), true));
    public static final Supplier<Item> FRIED_DRAGON_EGG = ITEMS.register("fried_dragon_egg",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.FRIED_DRAGON_EGG), true));
    public static final Supplier<Item> SHULKER_MEAT = ITEMS.register("shulker_meat",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SHULKER_MEAT), true));
    public static final Supplier<Item> SHULKER_MEAT_SLICE = ITEMS.register("shulker_meat_slice",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SHULKER_MEAT_SLICE), true));
    public static final Supplier<Item> ROASTED_SHULKER_MEAT = ITEMS.register("roasted_shulker_meat",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ROASTED_SHULKER_MEAT), true));
    public static final Supplier<Item> ROASTED_SHULKER_MEAT_SLICE = ITEMS.register("roasted_shulker_meat_slice",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ROASTED_SHULKER_MEAT_SLICE), true));
    public static final Supplier<Item> DRAGON_LEG = ITEMS.register("dragon_leg",
            () -> new Item(new Item.Properties().food(FoodList.DRAGON_LEG)));
    public static final Supplier<Item> SMOKED_DRAGON_LEG = ITEMS.register("smoked_dragon_leg",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SMOKED_DRAGON_LEG), true));
    public static final Supplier<Item> RAW_DRAGON_MEAT = ITEMS.register("raw_dragon_meat",
            () -> new Item(new Item.Properties().food(FoodList.RAW_DRAGON_MEAT)));
    public static final Supplier<Item> ROASTED_DRAGON_MEAT = ITEMS.register("roasted_dragon_meat",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ROASTED_DRAGON_MEAT), true));
    public static final Supplier<Item> RAW_DRAGON_MEAT_CUTS = ITEMS.register("raw_dragon_meat_cuts",
            () -> new Item(new Item.Properties().food(FoodList.RAW_DRAGON_MEAT_CUTS)));
    public static final Supplier<Item> ROASTED_DRAGON_MEAT_CUTS = ITEMS.register("roasted_dragon_meat_cuts",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ROASTED_DRAGON_MEAT_CUTS), true));
    public static final Supplier<Item> RAW_ENDERMITE_MEAT = ITEMS.register("raw_ender_mite_meat",
            () -> new Item(new Item.Properties().food(FoodList.RAW_ENDERMITE_MEAT)));
    public static final Supplier<Item> DRIED_ENDERMITE_MEAT = ITEMS.register("dried_endermite_meat",
            () -> new Item(new Item.Properties().food(FoodList.DRIED_ENDERMITE_MEAT)));
    public static final Supplier<Item> ENDERMAN_GRISTLE = ITEMS.register("enderman_gristle",
            () -> new EndermanGristleItem(new Item.Properties().food(FoodList.ENDERMAN_GRISTLE), 0.3F, false));
    public static final Supplier<Item> CHORUS_SAUCE = ITEMS.register("chorus_sauce",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.CHORUS_SAUCE).craftRemainder(Items.BOWL).stacksTo(64)));
    public static final Supplier<Item> SHULKER_OMELETTE_MIXTURE = ITEMS.register("shulker_omelette_mixture",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SHULKER_OMELETTE_MIXTURE),true));
    public static final Supplier<Item> SHULKER_OMELETTE = ITEMS.register("shulker_omelette",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SHULKER_OMELETTE),true));
    public static final Supplier<Item> RAW_ENDER_SAUSAGE = ITEMS.register("raw_ender_sausage",
            () -> new EndermanGristleItem(new Item.Properties().food(FoodList.RAW_ENDER_SAUSAGE), 0.3F, false));
    public static final Supplier<Item> ENDER_SAUSAGE = ITEMS.register("ender_sausage",
            () -> new EndermanGristleItem(new Item.Properties().food(FoodList.ENDER_SAUSAGE), 0.2F, true, true));
    public static final Supplier<Item> ENDER_BAMBOO_RICE = ITEMS.register("ender_bamboo_rice",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ENDER_BAMBOO_RICE), true));
    public static final Supplier<Item> STUFFED_RICE_CAKE = ITEMS.register("stuffed_rice_cake",
            () -> new ConsumableChorusItem(new Item.Properties().food(FoodList.STUFFED_RICE_CAKE), true));
    public static final Supplier<Item> CHORUS_FLOWER_PIE = ITEMS.register("chorus_flower_pie",
            () -> new ConsumableChorusItem(new Item.Properties().food(FoodList.CHORUS_FLOWER_PIE), true, true));
    public static final Supplier<Item> CHORUS_COOKIE = ITEMS.register("chorus_cookie",
            () -> new ConsumableChorusItem(new Item.Properties().food(FoodList.CHORUS_COOKIE), true));
    public static final Supplier<Item> CHORUS_FRUIT_POPSICLE = ITEMS.register("chorus_fruit_popsicle",
            () -> new ChorusFruitPopsicleItem(new Item.Properties().food(FoodList.CHORUS_FRUIT_POPSICLE).stacksTo(16)));
    //Drink
    public static final Supplier<Item> CHORUS_FRUIT_WINE = ITEMS.register("chorus_fruit_wine",
    ...
    public static final Supplier<Item> CHORUS_FRUIT_MILK_TEA = ITEMS.register("chorus_fruit_milk_tea",
            () -> new BubbleTeaItem(new Item.Properties().food(FoodList.CHORUS_FRUIT_MILK_TEA).stacksTo(16).craftRemainder(Items.GLASS_BOTTLE)));
    public static final Supplier<Item> BUBBLE_TEA = ITEMS.register("bubble_tea",
            () -> new BubbleTeaItem(new Item.Properties().food(FoodList.BUBBLE_TEA).stacksTo(16).craftRemainder(Items.GLASS_BOTTLE)));
    public static final Supplier<Item> DRAGON_BREATH_SODA = ITEMS.register("dragon_breath_soda",
    ...
    public static final Supplier<Item> CHORUS_FLOWER_TEA = ITEMS.register("chorus_flower_tea",
    ...
    //Pie
    public static final Supplier<Item> CHORUS_FRUIT_PIE = ITEMS.register("chorus_fruit_pie",
            () -> new BlockItem(ModBlocks.CHORUS_FRUIT_PIE.get(), new Item.Properties()));
    public static final Supplier<Item> CHORUS_FRUIT_PIE_SLICE = ITEMS.register("chorus_fruit_pie_slice",
            () -> new ConsumableChorusItem(new Item.Properties().food(FoodValues.PIE_SLICE), true, true));
    //Congee
    public static final Supplier<Item> ENDER_CONGEE = ITEMS.register("ender_congee",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ENDER_CONGEE).craftRemainder(Items.BOWL).stacksTo(16), true));
    //Soup
    public static final Supplier<Item> DRAGON_BREATH_AND_CHORUS_SOUP = ITEMS.register("dragon_breath_and_chorus_soup",
    ...
    public static final Supplier<Item> SHULKER_SOUP = ITEMS.register("shulker_soup",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.SHULKER_SOUP).craftRemainder(Items.BOWL).stacksTo(16), true));
    //ConsumableItem
    public static final Supplier<Item> ENDER_NOODLE = ITEMS.register("ender_noodle",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ENDER_NOODLE).craftRemainder(Items.BOWL).stacksTo(16), true));
    public static final Supplier<Item> ENDERMAN_GRISTLE_STEW = ITEMS.register("enderman_gristle_stew",

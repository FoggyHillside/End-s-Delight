...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> EnderSauce = ITEMS.register("ender_sauce",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.EnderSauce).craftRemainder(Items.BOWL).stacksTo(16)));
    ...
    public static final RegistryObject<Item> AssortedSalad = ITEMS.register("assorted_salad",
            ()-> new ConsumableItem(new Item.Properties().food(FoodList.AssortedSalad).craftRemainder(ItemRegistry.DragonEggShell.get()).stacksTo(16), true));
    //BarbecueStick

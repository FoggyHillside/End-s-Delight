...
public class EndStoveBlockEntity extends AbstractStoveBlockEntity
{
	...
	public static void particleTick(Level level, BlockPos pos, BlockState state, EndStoveBlockEntity endStoveEntity) {
		if (endStoveEntity.isEmpty()) return;
		endStoveEntity.addSmokeParticles();
	}
